 ...
 */
public class VentanaRutMostrarCliente extends javax.swing.JFrame {
    
    private ProCable procable;
    /**
     * Creates new form VentanaRutMostrarCliente
     */
    public VentanaRutMostrarCliente(ProCable procable) {
        initComponents();
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        if(jTextRut.getText().equals("")){
            ...
            if(((this.procable).buscarCliente(jTextRut.getText())) == true){
                VentanaMostrarCliente submenu = new VentanaMostrarCliente(procable,jTextRut.getText());
