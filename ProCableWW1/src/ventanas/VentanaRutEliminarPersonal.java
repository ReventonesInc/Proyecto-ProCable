 ...
 */
public class VentanaRutEliminarPersonal extends javax.swing.JFrame {
    
    private ProCable procable;
    /**
     * Creates new form VentanaRutEliminarPersonal
     */
    public VentanaRutEliminarPersonal(ProCable procable) {
        initComponents();
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        ...
        if(jTextRut.getText().equals("")){
            ...
            if(((this.procable).buscarPersonal(jTextRut.getText())) == true){
                VentanaPersonalEliminar submenu = new VentanaPersonalEliminar(procable,jTextRut.getText());
