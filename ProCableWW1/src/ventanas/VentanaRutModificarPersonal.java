 ...
 */
public class VentanaRutModificarPersonal extends javax.swing.JFrame {
    
    private ProCable procable;
    /**
     * Creates new form VentanaRutModificarPersonal
     */
    public VentanaRutModificarPersonal(ProCable procable) {
        initComponents();
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        ...
        if(jTextRut.getText().equals("")){
            ...
            if(((this.procable).buscarPersonal(jTextRut.getText())) == true){
                VentanaPersonalModificar submenu = new VentanaPersonalModificar(procable,jTextRut.getText());
